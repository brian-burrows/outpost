...
from auth.endpoints.system import router as system_router
...
app = FastAPI(
    title="Outpost Authorization API",
    description="API Gateway for authenticating and authorizing requests for downstream APIs.",
    version="1.0.0"
)
