...
from owm.consumer import TaskConsumer, TaskProcessingManager
from owm.deduplication import (
    RedisDeduplicationCacheRepository,
    with_deduplication_caching,
)
from owm.handlers import SignalCatcher
...
from owm.tasks import OwmIngestionTask, WeatherCategorizationTask
...
def _flush_producer_from_disk_to_queue(
    ...
    try:
        while not catcher.stop_event.is_set():
            ...
            producer.flush_tasks_to_queue(batch_size=batch_size)
